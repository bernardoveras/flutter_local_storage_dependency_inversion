import 'package:local_storage_dependency_inversion/src/shared/services/local_storage/data/services/local_storage_service_with_shared_preferences_impl.dart';
...
void main() {
  ...
  setUpAll(() async {
    ...
    localStorageService = LocalStorageServiceWithSharedPreferencesImpl(sharedPreferences);
  });
